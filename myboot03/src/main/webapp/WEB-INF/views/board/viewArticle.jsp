...
<body>
	<form action="${contextPath}" name="frmArticle" method="post" enctype="multipart/form-data">
		<table border="0" align="center">
			<tr>
				<td width="150" align="center" bgcolor="#dcdcdc">글번호</td>
				<td>
			...
			<tr>
				<td width="150" align="center" bgcolor="#dcdcdc">작성자 아이디</td>
				<td>
					<input type="text" value="${article.id}" name="writer" disabled="disabled" />
				</td>
			</tr>
			<tr>
				<td width="150" align="center" bgcolor="#dcdcdc">제목</td>
				<td><input type="text" value="${article.title}" name="title" id="i_title" disabled="disabled"></td>
			</tr>
			<tr>
				<td width="150" align="center" bgcolor="#dcdcdc">내용</td>
			...
			<c:choose>
				<c:when test="${not empty article.imageFileName && article.imageFileName != 'null'}">
					<tr>
						<td width="150" align="center" bgcolor="#dcdcdc" rowspan="2">이미지</td>
						<td>
			...
			<tr>
				<td width="150" align="center" bgcolor="#dcdcdc">등록일자</td>
				<td>
